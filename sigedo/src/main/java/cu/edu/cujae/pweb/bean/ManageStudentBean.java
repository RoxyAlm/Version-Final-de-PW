...
@ManagedBean
@RequestScope // Este es el alcance utilizado para trabajar con Ajax
...
//	puede ser que necesite implementar los municipios a los q pertence el estudiante
	...
	public void openForEdit() {
		this.selectedMunicipality = this.selectedStudent.getMunicipality() != null
				? this.selectedStudent.getMunicipality()
				: null;
